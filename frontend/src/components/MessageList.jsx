      ...
      {messages.length === 0 && !isLoading ? (
        <div className="h-full flex flex-col items-center justify-center gap-4 text-center">
          <div className="flex flex-col gap-1.5">
            <h1 className="text-[20px] font-semibold text-slate-200 tracking-tight">orbit</h1>
            <h3 className="text-[15px] font-semibold text-slate-400 tracking-tight">How can I assist you?</h3>
          ...
          <div className="flex flex-wrap justify-center gap-2 mt-1">
            {["Write a Netflix clone", "Explain Javascript", "Build a dashboard"].map((s) => (
              <button
                key={s}
